...
export class DashboardPageComponent implements AfterViewInit {
  ...
  async getImage() {
  try {
    // URL alternative (Picsum fournit aussi des images aléatoires)
    ...
    const card: Card = {
      id: this.listeUsers.length + 1,
      userName: 'gamtchessi_dev',
      url: url,
      description: '3D'
    };
    ...
    // Utilisation d'une image de secours locale
    const fallbackUrl = 'assets/images/default.jpg'; // Assure-toi que ce fichier existe
